...
{ static unsigned char key_count;
    ...
    clear_screen();
    clcd_print("Pre-Heating",(0x80 + 2));
    clcd_print("Time Rem :",(0x90 + 0));
     clcd_print("Sec :",(0x90 + 13));
    pre_heat_time=60;
    TMR2ON=1;
    while(pre_heat_time!=0)
    {
     clcd_putch((pre_heat_time/100)+'0',(0x90 + 10));
     clcd_putch(((pre_heat_time/10)%10+'0'),(0x90 + 11));
     clcd_putch((pre_heat_time%10+'0'),(0x90 + 12));
    }
